...
namespace Drupal\pds_recipe_slider_banner\Controller;
...
final class RowController extends ControllerBase {
  ...
  public function createRow(Request $request, string $uuid): JsonResponse {
    ...
    try {
      ...
      \Drupal::logger('pds_recipe_slider_banner')->error('Row creation failed for group @group: @message', [
        '@group' => $uuid,
  ...
  private function resolveSchemaRepairer(): ?object {
    ...
    return \pds_recipe_slider_banner_resolve_schema_repairer();
  }
