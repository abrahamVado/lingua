...
final class PdsTemplateBlock extends BlockBase {
  ...
  public function defaultConfiguration(): array {
    return [
      ...
      'recipe_type' => 'pds_recipe_internacional',
    ];
  }
  ...
  private function ensureGroupAndGetId(): int {
    ...
    $type = $this->configuration['recipe_type'] ?? 'pds_recipe_internacional';

    //1.- Leverage the shared procedural helper so controllers and forms reuse identical logic.
    $group_id = \pds_recipe_internacional_ensure_group_and_get_id($uuid, $type);
  ...
  public function build(): array {
    ...
    return [
      ...
      '#attached' => [
        'library' => [
          'pds_recipe_internacional/pds_template.public',
        ],
        'drupalSettings' => [
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $recipe_type = $this->configuration['recipe_type'] ?? 'pds_recipe_internacional';
    ...
    $ensure_group_url = Url::fromRoute(
      'pds_recipe_internacional.ensure_group',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
    ...
    $resolve_row_url = Url::fromRoute(
      'pds_recipe_internacional.resolve_row',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
      ],
    ...
    $create_row_url = Url::fromRoute(
      'pds_recipe_internacional.create_row',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
        'query' => ['type' => $recipe_type],
    ...
    $update_row_url = Url::fromRoute(
      'pds_recipe_internacional.update_row',
      [
        'uuid' => $block_uuid,
    ...
    $list_rows_url = Url::fromRoute(
      'pds_recipe_internacional.list_rows',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
        'query' => $list_query,
    ...
    $form['pds_template_admin'] = [
      ...
      '#attached' => [
        'library' => [
          'pds_recipe_internacional/pds_template.admin',
        ],
      ],
    ];
  ...
  public static function ajaxResolveRow(Request $request, string $uuid): JsonResponse {
    ...
    if (!pds_recipe_internacional_user_can_manage_template()) {
    ...
    $promoter = \pds_recipe_internacional_resolve_row_image_promoter();
    if (!$promoter) {
      return new JsonResponse([
        'status' => 'error',
