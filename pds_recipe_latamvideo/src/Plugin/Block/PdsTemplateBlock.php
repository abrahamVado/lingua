 ...
 *   admin_label = @Translation("PDS LATAM video"),
...
final class PdsTemplateBlock extends BlockBase {
  ...
  public function defaultConfiguration(): array {
    return [
      ...
      'recipe_type' => 'pds_recipe_latamvideo',
    ];
  }
  ...
  private function ensureGroupAndGetId(): int {
    ...
    $type = $this->configuration['recipe_type'] ?? 'pds_recipe_latamvideo';

    //1.- Leverage the shared procedural helper so controllers and forms reuse identical logic.
    $group_id = \pds_recipe_latamvideo_ensure_group_and_get_id($uuid, $type);
  ...
  public function build(): array {
    ...
    return [
      ...
      '#attached' => [
        'library' => [
          'pds_recipe_latamvideo/pds_template.public',
        ],
        'drupalSettings' => [
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $recipe_type = $this->configuration['recipe_type'] ?? 'pds_recipe_latamvideo';
    ...
    $ensure_group_url = Url::fromRoute(
      'pds_recipe_latamvideo.ensure_group',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
    ...
    $resolve_row_url = Url::fromRoute(
      'pds_recipe_latamvideo.resolve_row',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
      ],
    ...
    $create_row_url = Url::fromRoute(
      'pds_recipe_latamvideo.create_row',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
        'query' => ['type' => $recipe_type],
    ...
    $update_row_url = Url::fromRoute(
      'pds_recipe_latamvideo.update_row',
      [
        'uuid' => $block_uuid,
    ...
    $list_rows_url = Url::fromRoute(
      'pds_recipe_latamvideo.list_rows',
      ['uuid' => $block_uuid],
      [
        'absolute' => TRUE,
        'query' => $list_query,
    ...
    $form['pds_template_admin'] = [
      ...
      '#attached' => [
        'library' => [
          'pds_recipe_latamvideo/pds_template.admin',
        ],
      ],
    ];
  ...
  public static function ajaxResolveRow(Request $request, string $uuid): JsonResponse {
    ...
    if (!pds_recipe_latamvideo_user_can_manage_template()) {
    ...
    $promoter = \pds_recipe_latamvideo_resolve_row_image_promoter();
    if (!$promoter) {
      return new JsonResponse([
        'status' => 'error',
