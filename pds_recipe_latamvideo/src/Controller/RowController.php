...
namespace Drupal\pds_recipe_latamvideo\Controller;
...
final class RowController extends ControllerBase {
  ...
  public function createRow(Request $request, string $uuid): JsonResponse {
    ...
    try {
      ...
      \Drupal::logger('pds_recipe_latamvideo')->error('Row creation failed for group @group: @message', [
        '@group' => $uuid,
  ...
  private function resolveSchemaRepairer(): ?object {
    ...
    return \pds_recipe_latamvideo_resolve_schema_repairer();
  }
