...
/**
 * Provides the PDS Contact Form recipe block.
 *
 * @Block(
 *   id = "pds_contact_form_block",
 *   admin_label = @Translation("PDS Contact Form"),
 *   category = @Translation("PDS Recipes")
 * )
 */
class PdsContactFormBlock extends BlockBase {
  ...
  public function build(): array {
    ...
    return [
      '#theme' => 'pds_contact_form',
      '#attributes' => [
        'class' => [
          'recipe-component',
          'recipe-component--contact-form',
        ],
      ],
      '#title' => $this->t('Request a consultation'),
      '#description' => $this->t('Starter content for the pds contact form experience.'),
      '#items' => [
        [
