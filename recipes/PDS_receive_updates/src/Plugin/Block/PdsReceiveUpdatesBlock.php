...
/**
 * Provides the PDS Receive Updates recipe block.
 *
 * @Block(
 *   id = "pds_receive_updates_block",
 *   admin_label = @Translation("PDS Receive Updates"),
 *   category = @Translation("PDS Recipes")
 * )
 */
class PdsReceiveUpdatesBlock extends BlockBase {
  ...
  public function build(): array {
    ...
    return [
      '#theme' => 'pds_receive_updates',
      '#attributes' => [
        'class' => [
          'recipe-component',
          'recipe-component--receive-updates',
        ],
      ],
      '#title' => $this->t('Stay informed'),
      '#description' => $this->t('Starter content for the pds receive updates experience.'),
      '#items' => [
        [
