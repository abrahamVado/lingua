...
function clearInputs(root) {
  ...
  function updateTimelineDatasetSnapshot(root, rows) {
    ...
    if (typeof drupalSettings === 'undefined' || !drupalSettings || !drupalSettings.pdsRecipeAvisosNormativos) {
      return;
    }
    ...
    if (!drupalSettings.pdsRecipeAvisosNormativos.masters) {
      drupalSettings.pdsRecipeAvisosNormativos.masters = {};
    }
    if (!drupalSettings.pdsRecipeAvisosNormativos.masters[instanceUuid]) {
      drupalSettings.pdsRecipeAvisosNormativos.masters[instanceUuid] = { metadata: {}, datasets: {} };
    }

    var master = drupalSettings.pdsRecipeAvisosNormativos.masters[instanceUuid];
    if (!master.datasets) {
      master.datasets = {};
    }
